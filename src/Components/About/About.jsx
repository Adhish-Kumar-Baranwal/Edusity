  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>With focus on innovation, hands-on learning, and personalized mentorship, our programs prepare aspiring educators to make a meaningful impact inclassrooms, schools and communities</p>
